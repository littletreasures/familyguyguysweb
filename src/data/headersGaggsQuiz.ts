...
export const HEADERS_GAGGS_QUESTIONS: QuizQuestion[] = [
  {
    ...
    prompt: "You're watching your fourth Family Guy episode of the day. An Amish man's horse explodes for no particular reason. Nobody in the scene reacts. The show moves on immediately to something even more inexplicable.",
    options: [
      {
        id: "q1-a",
  ...
  },
  {
    ...
    prompt: "43 minutes into the podcast, we have discussed the first two minutes of the actual Family Guy episode, and Collin just popped the top back open on an argument about whether convertibles are fun that started before recording.",
    options: [
      {
        id: "q3-a",
  ...
  },
  {
    ...
    prompt: "An 80-page menu that weighs more than most Bibles lists avocado eggrolls directly above shepherd's pie and directly below funnel cake. Nothing about this menu apologizes for itself.",
    options: [
      {
        id: "q4-a",
  ...
  },
  {
    ...
    prompt: "You've been asked to cut a chicken fight down from 3 minutes to 90 seconds. The first 30 seconds are great. The next two and a half minutes get more and more punishing in a way that starts to feel intentional.",
    options: [
      {
        id: "q5-a",
    ...
    options: [
      {
        id: "q6-a",
        text:
          "Forty seconds of nothing? No additional character development? No callback? I feel like I'm being held hostage here. Somebody cut this fucking thing.",
        scores: { struct: 3, cherry: 1 },
      },
      {
        id: "q6-b",
        text:
          "The first 14 seconds are the gunshot. The next 40 are the body hitting the floor in slow motion. Somebody crank up the Drowning Pool. I'm loving this",
        scores: { gag: 2, hat: 3 },
      },
      {
        id: "q6-c",
        text:
          "I'm struggling to see how the extra 40 makes the original joke funnier. I'm trying here... can we add some sound effects? Cap it off with a little something-something? It's missing that little something special.",
        scores: { gag: 1, cherry: 3 },
      },
      {
        id: "q6-d",
        text:
          "I set a reminder for myself to send it to the chat every morning until none of us can tell whether his realization is still funny or if we’ve become bad people.",
        scores: { struct: 1, hat: 2 },
      },
    ],
  },
  {
    ...
    prompt: "A prestige drama halts its emotional climax so a character can perform an unprompted 3-minute song about a brand of cereal that hasn't existed since '84.",
    options: [
      {
        id: "q7-a",
  ...
  },
  {
    ...
    prompt: "It's 18 minutes in. There's at least three more minutes left in the episode. Peter looks directly at the camera, says \"Well, I guess that was our show,\" and the credits roll with zero setups resolved.",
    options: [
      {
        id: "q8-a",
